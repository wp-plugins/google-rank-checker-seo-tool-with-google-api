...
<?
 try{
		...
		?>	
     		...
     		<div class="updated" style="margin-bottom:10px;"><p><strong><?php _e('' .$functions->message); ?></strong></p></div>
        	    ...
        	    <div class="wrap">
                        ...
                        <tbody>
                           ...
                           <tr>
                            ...
                            <? if (intval($keyword->_page)>get_option('optimum7_google_ranking_checker_max_page')){?>
                             ...
                             <td style="text-align:right"><code><?php echo $keyword->_position; ?></code></td>
                 ...
                 <span class="description">In order to create a Wordpress Page or Post to show the results, please paste any of the following codes: <strong><code>[optimum7_google_ranking_checker_form]</code></strong> Or <code><strong>[optimum7_google_ranking_checker_form_2]</code></strong></span>
