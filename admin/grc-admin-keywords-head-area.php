	...
	<div class="postbox">
        ...
        <div id="news-support" class="clearfix">
        	...
        	<div id="banner-support">			
            	...
            	<a href="http://www.optimum7.com?utm_source=RankCheckPlugin"><img src="<? echo get_bloginfo('wpurl').'/wp-content/plugins/google-rank-checker-seo-tool-with-google-api/images/opt7-logo.png"'?>" width="206" height="40"/></a>
           ...
           <?
			...
			try{
				$result =  $functions->get_rss_feed($xml,ini_get('allow_url_fopen'));
				echo $result;
			}
			catch (Exception $e){	
			   echo $e->getMessage();
