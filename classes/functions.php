...
class functions{
	...
	public function get_rss_feed($xml,$allow_url_fopen)

	{
...

			{
...

				{
					...
					$result = $result."<p style='margin-left:10px;'><a href='" . $channel_link. "'>" . $channel_title . " (Optimum7)</a>";
					...
					for ($i=0; $i<=9; $i++){
					  ...
					  $result = $result."<li><a href='" . $item_link."?utm_source=RankCheckPlugin'>" . $item_title . "</a></li>";
				...
				$result = "<li><a href='http://www.optimum7.com/contact-us?utm_source=RankCheckPlugin'> Plugin Support</a></li>";	
				$result = $result."<li><a href='http://www.optimum7.com/alpha/seo/main-analysis-bullets-2.html?utm_source=RankCheckPlugin'> Website Analysis </a></li>";	
				$result = $result."<li><a href='http://www.optimum7.com/?utm_source=RankCheckPlugin'> Internet Marketing Services </a></li>";	
				$result = $result."<li><a href='http://www.optimum7.com/internet-marketing/?utm_source=RankCheckPlugin'> Internet Marketing Articles </a></li>";	
				return $result;
