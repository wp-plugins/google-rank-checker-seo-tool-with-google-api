...
class functions{
	...
	public function get_rss_feed($xml,$allow_url_fopen)
	{
			try
			{
				...
				$result = "<li><a href='http://optimum7.com/index.php?utm_source=RankCheckPlugin'> Internet Marketing Services </a></li>";	
				$result = $result."<li><a href='http://blog.optimum7.com/index.php?utm_source=RankCheckPlugin'> Optimum7 Blog </a></li>";	
				$result = $result."<li><a href='https://optimum7.wufoo.com/forms/google-rank-checker-support?utm_source=RankCheckPlugin'> Plugin Support </a></li>";			
				return $result;
			}
			catch (Exception $e){	
			}
