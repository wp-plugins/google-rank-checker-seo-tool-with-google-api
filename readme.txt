...
<<<<<<< .mineGoogle Rank Checker - SEO Tool with Google API provides the estimated Google position for a keyword and corresponding URL.
...
>>>>>>> .theirsGoogle Rank Checker - SEO Tool with Google API is a WordPress plugin that provides the estimated Google position for a keyword and corresponding URL. It also provides the competitive pages for any pre-defined keyword list on a keyword for keyword basis.
<<<<<<< .mine=======
...
<<<<<<< .mineMajor new features in Google Rank Checker - SEO Tool with Google API 4.0.0 include:


=======Major new features in Google Rank Checker - SEO Tool with Google API 3.0.4 include:


>>>>>>> .theirs* Rules to define: Maximum CPC, The top Google page, Min Cost Per Click, etc.
* Google Adwords Account
* Two different views to show results.
* 2011 Google API
* New keywords can be added dynamically.
<<<<<<< .mine* Customized levels for keywords
...
>>>>>>> .theirsPS: You'll need an [Google API key] and a [Google Adwords Account] in order to use it properly.
<<<<<<< .mineGoogle Rank Checker - SEO Tool with Google API - http://www.optimum7.com/internet-marketing/wordpress-2/google-rank-checker-wordpress-plugin-google-api.html?utm_source=RankCheckPlugin
...
=======>>>>>>> .theirs== Installation ==
<<<<<<< .mine=======
>>>>>>> .theirsUpload the Google Rank Checker - SEO Tool with Google API plugin to your blog, Activate it and define a Google AdWords Account.
1, 2, 3: You're done!